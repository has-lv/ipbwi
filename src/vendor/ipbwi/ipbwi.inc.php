...
//					ipbwi_OVERWRITE_CHARSET
		...
		/**
		 * @desc			returns system messages as array
		 * @return	true	array containing system messages messages
		 * @author			Matthias Reuter
		 * @since			3.5.3
		 */
		public static function returnSystemMessages(){
		...
		public function makeSafe($var){
			...
			*/
			...
			}elseif(defined('ipbwi_UTF8') && ipbwi_UTF8){
